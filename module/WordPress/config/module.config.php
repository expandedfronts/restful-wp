...
// Defines the API slug.
$api_slug = function_exists('apply_filters') ? apply_filters( 'restful_wp_api_slug', 'restful-wp' ) : 'restful-wp';
...
return array(
    'router' => array(
        'routes' => array(
            ...
            'word-press.rest.postmeta' => array(
                'type' => 'Segment',
                'options' => array(
                    'route' => '/' . $api_slug . '/posts/:post_id/meta[/:postmeta_id]',
                    'defaults' => array(
            ...
            'word-press.rest.usermeta' => array(
                'type' => 'Segment',
                'options' => array(
                    'route' => '/' . $api_slug . '/users/:user_id/meta[/:usermeta_id]',
                    'defaults' => array(
            ...
            'word-press.rest.comments' => array(
                'type' => 'Segment',
                'options' => array(
                    'route' => '/' . $api_slug . '/comments[/:comments_id]',
                    'defaults' => array(
            ...
            'word-press.rest.commentmeta' => array(
                'type' => 'Segment',
                'options' => array(
                    'route' => '/' . $api_slug . '/comments/:comment_id/meta[/:commentmeta_id]',
                    'defaults' => array(
            ...
            'word-press.rest.options' => array(
                'type' => 'Segment',
                'options' => array(
                    'route' => '/' . $api_slug . '/options[/:options_id]',
                    'defaults' => array(
            ...
            'word-press.rest.taxonomies' => array(
                'type' => 'Segment',
                'options' => array(
                    'route' => '/' . $api_slug . '/taxonomies[/:taxonomies_id]',
                    'defaults' => array(
    ...
    'zf-versioning' => array(
        'uri' => array(
            ...
            1 => 'word-press.rest.postmeta',
            2 => 'word-press.rest.users',
            3 => 'word-press.rest.usermeta',
            4 => 'word-press.rest.comments',
            5 => 'word-press.rest.commentmeta',
            6 => 'word-press.rest.options',
            7 => 'word-press.rest.taxonomies',
        ),
    ),
    ...
    'zf-content-negotiation' => array(
        'controllers' => array(
            'WordPress\\V1\\Rest\\Posts\\Controller' => 'HalJson',
